...
def mainGame():
    ...
    #craete 2 pipes for blitting on the screen
    ...
    while True:
        ...
        #add a new pipe when the first is abt to cross the leftmost part of the screen
...
def getRandomPipe():
    '''
    generate postions of two pipes(one bottom straight and one top rotated) for blitting on the screeen
...
if __name__=="__main__":
    ...
    pygame.display.set_caption("Flappy Bird By Nayana")
    ...
    while True:
        welcomeScreen() #function shows welcome screen to the user until he presses a button
        mainGame()      #function this is the main function
